...
$query2 = mysqli_query($connection, "INSERT INTO DailyFoodData(Food, Calories, Weight, Protein, Carbohydrates, Sugars, Username, Dates) VALUES ('$food2', '$calories2', '$weight2', '$protein2', '$carbohydrates2', '$sugars2', '$username', '$date2')")
or die("Unable to connect to MySQL");
